...
console.log(process.env.ME_CONFIG_MONGODB_AUTH);
console.log(JSON.parse(process.env.ME_CONFIG_MONGODB_AUTH)[0].database);
module.exports = {
    mongodb: {
        ...
        admin: (process.env.ME_CONFIG_MONGODB_ADMIN_MODE === "true"),


        // >>>>  If you are using regular accounts, fill out auth details in the section below
        // >>>>  If you have admin auth, leave this section empty and skip to the next section
        auth: JSON.parse(process.env.ME_CONFIG_MONGODB_AUTH),
